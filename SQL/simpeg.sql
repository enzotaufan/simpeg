...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2018 at 02:51 AM
...
(1, 'Maulana', 'admin@gmail.com', 'Taufan', '21232f297a57a5a743894a0e4a801fc3', 'admin', 'e9225b2e6a4db06e6df53f2623d7ba38.jpg'),
(6, 'baak', 'baak@gmail.com', 'Ka. BAAK', '21232f297a57a5a743894a0e4a801fc3', 'baak', '2b10f8e9a8cf35bd216750928492d585.jpg'),
...
CREATE TABLE IF NOT EXISTS `tb_namaizin` (
`id_namaizin` int(255) NOT NULL,
  `type` varchar(255) COLLATE utf8mb4_unicode_520_ci NOT NULL,
